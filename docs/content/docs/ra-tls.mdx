...
Implementation in [`tee/cocoon/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp) — function `generate_tdx_self_signed_cert`.
...
Currently minimal (see [`tee/cocoon/tdx.h`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.h) and [`tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp)):
...
Implementation in [`tee/cocoon/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp) — struct `Verifier`.
...
Implementation in [`tee/cocoon/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp) — struct `DefaultPolicy`.
...
See [`tee/cocoon/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp) — function `DefaultPolicy::validate_tdx_attestation`. Policy checks:
...
Implementation in [`tee/cocoon/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp) — function `AttestationData::image_hash`.
...
The `router` tool ([`tee/cocoon`](https://github.com/TelegramMessenger/cocoon/tree/master/tee/cocoon)) provides transparent RA-TLS proxying. See [README](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/README.md) for detailed usage.
...
Implementation in [`tee/cocoon/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx.cpp) — function `create_ssl_ctx`.
