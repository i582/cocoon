...
Implementation in [`tee/cocoon/Tee.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/Tee.cpp#L31) — function `generate_tdx_self_signed_cert`.
...
Currently minimal (see [`tee/cocoon/tdx/tdx.h`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/tdx.h#L107) and [`tee/cocoon/tdx/tdx.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/tdx.cpp#L58)):
...
See [`tee/cocoon/gen-cert.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/gen-cert.cpp#L1):
...
Implementation in [`tee/cocoon/RATLS.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/RATLS.cpp#L203) — struct `Verifier`.
...
Implementation in [`tee/cocoon/RATLS.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/RATLS.cpp#L32) — struct `DefaultPolicy`.
...
See [`tee/cocoon/RATLS.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/RATLS.cpp#L48) — function `DefaultPolicy::validate_tdx_attestation`. Policy checks:
...
Implementation in [`tee/cocoon/tdx/RATLS.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/RATLS.cpp#L39) — function `AttestationData::image_hash`.
...
The `router` tool ([`tee/cocoon`](https://github.com/TelegramMessenger/cocoon/tree/main/tee/cocoon)) provides transparent RA-TLS proxying. See [`tee/cocoon/router.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/router.cpp#L306) for detailed usage.
...
Implementation in [`tee/cocoon/Tee.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/Tee.cpp#L307) — function `create_ssl_ctx`.
...
- For router usage details: [`tee/cocoon/router.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/router.cpp#L306)
