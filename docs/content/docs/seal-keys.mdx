...
Implementation: [`tee/cocoon/tdx/sgx-enclave/seal-client.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/sgx-enclave/seal-client.cpp#L40), [`seal-server.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/sgx-enclave/seal-server.cpp#L76), [`Enclave.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/sgx-enclave/Enclave.cpp#L115).
...
Implementation in [`seal-client.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/sgx-enclave/seal-client.cpp#L40) — class `GetPersistentKeyClient`.
...
Implementation in [`seal-server.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/sgx-enclave/seal-server.cpp#L76) — class `GetPersistentKeyServer`.
...
Implementation in [`Enclave.cpp`](https://github.com/TelegramMessenger/cocoon/blob/main/tee/cocoon/tdx/sgx-enclave/Enclave.cpp#L115) — function `ecall_gen_key`.
...
Implementations in [`tee/cocoon/tdx/sgx-enclave/`](https://github.com/TelegramMessenger/cocoon/tree/main/tee/cocoon/tdx/sgx-enclave).
...
Called by [`reprodebian/cocoon-init/cocoon-init`](https://github.com/TelegramMessenger/cocoon/blob/main/reprodebian/cocoon-init/cocoon-init#L1):
